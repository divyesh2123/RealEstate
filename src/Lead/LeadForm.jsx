...
const LeadForm = (props) => {
  ...
  if(id.length > 0)
  {
    authFetch.get(`/lead/view/${id[0]}`).then(y=>{
      formik.setFieldValue("leadStatus",y.data.lead["leadStatus"])
       formik.setFieldValue("leadName",y.data.lead["leadName"])
       formik.setFieldValue("leadEmail",y.data.lead["leadEmail"])
       formik.setFieldValue("leadPhoneNumber",y.data.lead["leadPhoneNumber"])
  ...
  const formik = useFormik({
    initialValues: {
      ...
      leadEmail: "",
      leadPhoneNumber: "",
      moduleId: "666d4ad64676048a592731eb",
    },
